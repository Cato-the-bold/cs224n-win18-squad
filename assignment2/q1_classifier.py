...
class SoftmaxModel(Model):
    ...
    def add_prediction_op(self):
        ...
        W = tf.Variable(tf.random_uniform([self.config.n_features, self.config.n_classes], -1.0, 1.0), name="W")
        b = tf.Variable(tf.random_uniform([1, self.config.n_classes], -1.0, 1.0), name="b")
